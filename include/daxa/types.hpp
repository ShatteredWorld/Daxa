...
#undef None
	...
	enum struct DaxaResult
	{
		...
		MISSING_EXTENSION = (1 << 30) + 0,
		INVALID_BUFFER_ID = (1 << 30) + 1,
		INVALID_IMAGE_ID = (1 << 30) + 2,
		INVALID_IMAGE_VIEW_ID = (1 << 30) + 3,
		INVALID_SAMPLER_ID = (1 << 30) + 4,
		BUFFER_DOUBLE_FREE = (1 << 30) + 5,
		IMAGE_DOUBLE_FREE = (1 << 30) + 6,
		IMAGE_VIEW_DOUBLE_FREE = (1 << 30) + 7,
		SAMPLER_DOUBLE_FREE = (1 << 30) + 8,
		INVALID_BUFFER_INFO = (1 << 30) + 9,
		INVALID_IMAGE_INFO = (1 << 30) + 10,
		INVALID_IMAGE_VIEW_INFO = (1 << 30) + 11,
		INVALID_SAMPLER_INFO = (1 << 30) + 12,
		COMMAND_LIST_COMPLETED = (1 << 30) + 13,
		COMMAND_LIST_NOT_COMPLETED = (1 << 30) + 14,
		INVALID_CLEAR_VALUE = (1 << 30) + 15,
		BUFFER_NOT_HOST_VISIBLE = (1 << 30) + 16,
		BUFFER_NOT_DEVICE_VISIBLE = (1 << 30) + 17,
		INCOMPLETE_COMMAND_LIST = (1 << 30) + 18,
		DEVICE_DOES_NOT_SUPPORT_BUFFER_COUNT = (1 << 30) + 19,
		DEVICE_DOES_NOT_SUPPORT_IMAGE_COUNT = (1 << 30) + 20,
		DEVICE_DOES_NOT_SUPPORT_SAMPLER_COUNT = (1 << 30) + 21,
		FAILED_TO_CREATE_NULL_BUFFER = (1 << 30) + 22,
		FAILED_TO_CREATE_NULL_IMAGE = (1 << 30) + 23,
		FAILED_TO_CREATE_NULL_IMAGE_VIEW = (1 << 30) + 24,
		FAILED_TO_CREATE_NULL_SAMPLER = (1 << 30) + 25,
		FAILED_TO_CREATE_BUFFER = (1 << 30) + 26,
		FAILED_TO_CREATE_IMAGE = (1 << 30) + 27,
		FAILED_TO_CREATE_IMAGE_VIEW = (1 << 30) + 28,
		FAILED_TO_CREATE_DEFAULT_IMAGE_VIEW = (1 << 30) + 29,
		FAILED_TO_CREATE_SAMPLER = (1 << 30) + 30,
		FAILED_TO_CREATE_BDA_BUFFER = (1 << 30) + 31,
		FAILED_TO_SUBMIT_DEVICE_INIT_COMMANDS = (1 << 30) + 32,
		INVALID_BUFFER_RANGE = (1 << 30) + 33,
		INVALID_BUFFER_OFFSET = (1 << 30) + 34,
		NO_SUITABLE_FORMAT_FOUND = (1 << 30) + 36,
		RANGE_OUT_OF_BOUNDS = (1 << 30) + 37,
		NO_SUITABLE_DEVICE_FOUND = (1 << 30) + 38,
		EXCEEDED_MAX_BUFFERS = (1 << 30) + 39,
		EXCEEDED_MAX_IMAGES = (1 << 30) + 40,
		EXCEEDED_MAX_IMAGE_VIEWS = (1 << 30) + 41,
		EXCEEDED_MAX_SAMPLERS = (1 << 30) + 42,
		DEVICE_SURFACE_UNSUPPORTED_PRESENT_MODE = (1 << 30) + 43,
		COMMAND_REFERENCES_INVALID_BUFFER_ID = (1 << 30) + 44,
		COMMAND_REFERENCES_INVALID_IMAGE_ID = (1 << 30) + 45,
		COMMAND_REFERENCES_INVALID_IMAGE_VIEW_ID = (1 << 30) + 46,
		COMMAND_REFERENCES_INVALID_SAMPLER_ID = (1 << 30) + 47,
		INVALID_ACCELERATION_STRUCTURE_ID = (1 << 30) + 48,
		EXCEEDED_MAX_ACCELERATION_STRUCTURES = (1 << 30) + 49,
		DEVICE_DOES_NOT_SUPPORT_RAYTRACING = (1 << 30) + 50,
		DEVICE_DOES_NOT_SUPPORT_MESH_SHADER = (1 << 30) + 51,
		INVALID_TLAS_ID = (1 << 30) + 52,
		INVALID_BLAS_ID = (1 << 30) + 53,
		INVALID_WITHOUT_ENABLING_RAY_TRACING = (1 << 30) + 54,
		NO_COMPUTE_PIPELINE_BOUND = (1 << 30) + 55,
		NO_RASTER_PIPELINE_BOUND = (1 << 30) + 56,
		NO_RAYTRACING_PIPELINE_BOUND = (1 << 30) + 57,
		NO_PIPELINE_BOUND = (1 << 30) + 58,
		PUSHCONSTANT_RANGE_EXCEEDED = (1 << 30) + 59,
		MESH_SHADER_NOT_DEVICE_ENABLED = (1 << 30) + 60,
		ERROR_COPY_OUT_OF_BOUNDS = (1 << 30) + 61,
		ERROR_NO_GRAPHICS_QUEUE_FOUND = (1 << 30) + 62,
		ERROR_COULD_NOT_QUERY_QUEUE = (1 << 30) + 63,
		ERROR_INVALID_QUEUE = (1 << 30) + 64,
		ERROR_CMD_LIST_SUBMIT_QUEUE_FAMILY_MISMATCH = (1 << 30) + 65,
		ERROR_PRESENT_QUEUE_FAMILY_MISMATCH = (1 << 30) + 66,
		ERROR_INVALID_QUEUE_FAMILY = (1 << 30) + 67,
		ERROR_INVALID_DEVICE_INDEX = (1 << 30) + 68,
		ERROR_DEVICE_NOT_SUPPORTED = (1 << 30) + 69,
		DEVICE_DOES_NOT_SUPPORT_ACCELERATION_STRUCTURE_COUNT = (1 << 30) + 70,
		ERROR_NO_SUITABLE_DEVICE_FOUND = (1 << 30) + 71,
		MAX_ENUM = 0x7FFFFFFF,
	};
