...
typedef daxa_Flags daxa_MissingRequiredVkFeatureFlags;

static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_NONE = 0;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_IMAGE_CUBE_ARRAY = 0x1 << 0;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_INDEPENDENT_BLEND = 0x1 << 1;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_TESSELLATION_SHADER = 0x1 << 2;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_MULTI_DRAW_INDIRECT = 0x1 << 3;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DEPTH_CLAMP = 0x1 << 4;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_FILL_MODE_NON_SOLID = 0x1 << 5;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_WIDE_LINES = 0x1 << 6;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SAMPLER_ANISOTROPY = 0x1 << 7;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_FRAGMENT_STORES_AND_ATOMICS = 0x1 << 8;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SHADER_INT64 = 0x1 << 9;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_IMAGE_GATHER_EXTENDED = 0x1 << 10;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_VARIABLE_POINTERS_STORAGE_BUFFER = 0x1 << 11;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_VARIABLE_POINTERS = 0x1 << 12;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_BUFFER_DEVICE_ADDRESS = 0x1 << 13;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_BUFFER_DEVICE_ADDRESS_CAPTURE_REPLAY = 0x1 << 14;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_BUFFER_DEVICE_ADDRESS_MULTI_DEVICE = 0x1 << 15;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SHADER_SAMPLED_IMAGE_ARRAY_NON_UNIFORM_INDEXING = 0x1 << 16;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SHADER_STORAGE_BUFFER_ARRAY_NON_UNIFORM_INDEXING = 0x1 << 17;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SHADER_STORAGE_IMAGE_ARRAY_NON_UNIFORM_INDEXING = 0x1 << 18;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DESCRIPTOR_BINDING_SAMPLED_IMAGE_UPDATE_AFTER_BIND = 0x1 << 19;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DESCRIPTOR_BINDING_STORAGE_IMAGE_UPDATE_AFTER_BIND = 0x1 << 20;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DESCRIPTOR_BINDING_STORAGE_BUFFER_UPDATE_AFTER_BIND = 0x1 << 21;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING = 0x1 << 22;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DESCRIPTOR_BINDING_PARTIALLY_BOUND = 0x1 << 23;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_RUNTIME_DESCRIPTOR_ARRAY = 0x1 << 24;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_HOST_QUERY_RESET = 0x1 << 25;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_DYNAMIC_RENDERING = 0x1 << 26;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SYNCHRONIZATION2 = 0x1 << 27;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_TIMELINE_SEMAPHORE = 0x1 << 28;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SUBGROUP_SIZE_CONTROL = 0x1 << 29;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_COMPUTE_FULL_SUBGROUPS = 0x1 << 30;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_SCALAR_BLOCK_LAYOUT = 1ULL << 31;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_HOST_IMAGE_COPY = 1ULL << 32;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_ACCELERATION_STRUCTURE_CAPTURE_REPLAY = 1ULL << 33;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_VULKAN_MEMORY_MODEL = 1ULL << 34;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_ROBUST_BUFFER_ACCESS2 = 1ULL << 35;
static daxa_MissingRequiredVkFeatureFlags const DAXA_MISSING_REQUIRED_VK_FEATURE_ROBUST_IMAGE_ACCESS2 = 1ULL << 36;


typedef enum
{
    DAXA_MISSING_RECCOMMENDED_VK_FEATURE_NONE = 0,
    DAXA_MISSING_RECCOMMENDED_VK_FEATURE_SHADER_STORAGE_IMAGE_MULTISAMPLE = 0x1 << 0,
    DAXA_MISSING_RECCOMMENDED_VK_FEATURE_SHADER_STORAGE_IMAGE_READ_WITHOUT_FORMAT = 0x1 << 1,
    DAXA_MISSING_RECCOMMENDED_VK_FEATURE_SHADER_STORAGE_IMAGE_WRITE_WITHOUT_FORMAT = 0x1 << 2,
} daxa_MissingReccommendedVkFeatureFlagBits;

typedef daxa_MissingReccommendedVkFeatureFlagBits daxa_MissingReccommendedVkFeatureFlags;
...
typedef struct
{
    ...
    daxa_MissingRequiredVkFeatureFlags missing_required_feature;
    daxa_MissingReccommendedVkFeatureFlags missing_reccommended_features;
