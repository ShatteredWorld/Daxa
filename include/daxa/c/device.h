...
typedef enum
{
    ...
    DAXA_IMPLICIT_FEATURE_FLAG_SHADER_STORAGE_IMAGE_MULTISAMPLE = 0x1 << 29,
    DAXA_IMPLICIT_FEATURE_FLAG_SHADER_STORAGE_IMAGE_READ_WITHOUT_FORMAT = 0x1 << 30,
...
typedef struct
{
    ...
    //daxa_MissingOptionalVkFeature missing_optional_feature;
